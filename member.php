...
<body>
  <header>
    ...
    <div class="pc-only">
      <ul class="menu-bar">
        <li class="menu-item"><a href="./book.html">本</a></li>
        <li class="menu-item"><a href="./typesetting.php">組版</a></li>
        <li class="menu-item"><a href="./programming.php">プログラミング</a></li>
        <li class="menu-item"><a href="./photo.php">写真</a></li>
        <li class="menu-item"><a href="./register.php">sign up</a></li>
        <li class="menu-item"><a href="./login.php">log in</a></li>
        <li class="menu-item"><a href="./contact.php">contact</a></li>
        <li class="menu-item"><a href="./board.php">bbs</a></li>
      </ul>
    </div>
  </header>
